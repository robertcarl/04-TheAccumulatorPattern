...
#        It is similar to k, used as a variable
...
#                  The second function would be wrong, as it has two different things defined as a radius
#                  and this wouldn't run properly
#
###############################################################################
